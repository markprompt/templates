  ...
  return (
    <Card>
      <div className="flex flex-col flex-no-wrap overflow-y-auto">
        <CardHeader
          className={cn(
            'space-y-1 sticky top-0 z-10 flex-shrink-0 min-w-0 min-h-0 bg-white/80 backdrop-blur',
        ...
        >
          ...
          <CardDescription>Describe the issue your are having</CardDescription>
        </CardHeader>
        <div
        ...
        >
          <CardContent className="flex-1 min-w-0 grid gap-4 relative pt-4 overflow-y-auto">
            <Messages />
            <div className="h-8" />
            <ChatScrollAnchor
              trackVisibility={
        ...
        <div className="sticky bottom-0 flex flex-col z-10">
          <CardContent
            className={cn('bg-white/80 backdrop-blur', {
          ...
          >
            <div className="flex-shrink-0 min-w-0 min-h-0">
              <PromptForm
                expanded={!isChatting}
                placeholder={
                  isChatting ? 'Send message' : 'I have an issue with...'
                }
                cta="Ask AI"
              />
            </div>
